const tournamentData = {
  ...
  rounds: [
    { title: '1/16 финала', format: 'BO1', matches: [
      [0, 1, 'https://www.youtube.com/live/P23OuOC2X9o?si=PHeTKjVix1u8znl4', "ART OF WAR MASTERS '26 SUMMER | -!..zAKIR AFG..!- vs Hero Dominator | LIVE"], [2, 3, 'https://www.youtube.com/live/Aw7cqsHh4jQ?si=ekK8VR0wev6x1NLO', 'White Pigeon vs VT_TaptapBoi C AOW3 MASTERS TOURNAMENT'],
      ...
      [12, 13, 'https://www.youtube.com/live/H77cRTTNz14?si=P0QaHe_eILJpE70R', 'Monirul Vs Mosina AOW3 MASTERS TOURNAMENT', { scores: [1, 0], eliminated: [false, true] }], [14, 15, 'https://www.youtube.com/live/isMbM1-cIu0?si=AQLMTkwNYUVOKq7F', 'kinghall VS Tairitsu AOW3 MASTERS TOURNAMENT', { scores: [1, 0], eliminated: [false, true] }],
      [16, 17, 'https://youtube.com/', 'Stream Nine'], [18, 19, 'https://www.youtube.com/live/gOk8OfqL8DA?si=npERgeN2iA3CYAQu', 'PiscesBrain YT VS Guten tag AOW3 MASTERS TOURNAMENT', { scores: [0, 1], eliminated: [true, false] }],
    ...
    { title: '1/8 финала', format: 'BO1', matches: [null, [null, 7, null, null, { scores: [0, 0] }], [8, 11, null, null, { scores: [0, 0] }], [12, 14, null, null, { scores: [0, 0] }], [null, 19, null, null, { scores: [0, 0] }], [20, 23, null, null, { scores: [0, 0] }], [null, 26, null, null, { scores: [0, 0] }], [null, 31, null, null, { scores: [0, 0] }]] },
  ...
  ranking: [
    ...
    ['-V.E.R.T.E.X-', 'VT_TaptapBoi C'], ['The lion heart', 'Amaan6', 1],
